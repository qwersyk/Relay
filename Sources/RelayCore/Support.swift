...
public struct RelayPaths {
    ...
    public init(root: URL? = nil) {
        self.root = root ?? FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Library/Application Support/Relay")
    }
    ...
    public var cli: String { "/Applications/ChatGPT.app/Contents/Resources/codex" }
